...
lodirizzini2009ras, 
%
pasetti2026iros,saccuti2026fmpmsa,
saccuti2025irc,panicieri2025iccp,
monica2024etfa,
fontana2023icraws,penzotti2023ecpa,
...
\begin{itemize}
\item Dario Lodi Rizzini \`e autore di \textbf{65} \emph{pubblicazioni scientifiche} complessive, di cui 
  \textbf{17} articoli su \emph{riviste internazionali}, 
  \textbf{41} articoli su \emph{atti di conferenze internazionali} con revisione sul testo completo,
  \textbf{1} \emph{capitolo su libro internazionale}

\item Indicatori bibliometrici (al 10/06/2026): 
  \begin{itemize}
  \item Scopus: citazioni \textbf{825}, h-index \textbf{16}
  \item Google Scholar: citazioni \textbf{1197}, h-index \textbf{18}
\end{itemize}
...
Un'attivit\`a attualmente ancora in corso \`e legata alla applicazione dei robot in ambito agricolo.
Nel progetto POR/FESR POSITIVE si \`e occupato di protocolli operativi per l'irrigazione di precisione dalla lettura di sensori all'attuazione di sprinkler ~\cite{amoretti2020smartsys, penzotti2023compag}. 
...
Nel progetto Agritech~\cite{monica2024etfa, saccuti2025irc} ha contribuito a realizzare un robot per la raccolta automatica di frutti di pomodori guidata da visione artificiale.
Nel progetto POR/FESR Agrarian ha studiato il riconoscimento di patologie della vite rtramite visione artificiale~\cite{saccuti2025data}.
...
\textbf{Pubblicazioni inerenti:}
5 lavori su rivista internazionale~\cite{saccuti2025data, penzotti2023compag, galasso2019rcim, kallasi2017ras, cigolini2014jamris},
9 lavori in atti di conferenze internazionali~\cite{saccuti2025irc, panicieri2025iccp, monica2024etfa, lodirizzini2022raad, amoretti2020smartsys, valeriani2013acra, lodirizzini2012icinco, calo2012icinco, argenti2010isr, lodirizzini2021simai, cerri2007ccmvs}.
...
\ITEMDATE{Gennaio 2024-2026. Bando PRIN 2022 ACTIVA}
...
\ITEMDATE{Settembre 2022-2026. Centro Nazionale per le Tecnologie dell’Agricoltura (AGRITECH) - Piano Nazione di Ripresa e Resilienza (PNRR), NextGenerationEU, CUP D93C22000420001}
Dario Lodi Rizzini partecipa alle attività dello SPOKE 3, in particolare al task 3.1.3 ``Autonomous robotic solutions for precise mechanization, irrigation, fertilization'', occupandosi di monitoraggio e campionamento delle colture tramite base robotica mobile equipaggiata con sensori per la percezione in campo. 
...
Titolo: ``Analisi dei Metodi di Cross-Localizzazione di Flotte di Veicoli e di Fusione Sensoriale'' (Gennaio 2025-Dicembre 2025)
Dario Lodi Rizzini \`e \underline{responsabile scientifico} (principal investigator) del progetto (importo di Euro 35.000,00) per l'esecuzione di attivit\`a di ricerca nell'ambito del progetto AIMONE (Autonomous Intelligence MObile - Next Evolution) sul Bando Accordo Innovazione DM 31/12/2021 (Primo Bando) CUP B19J23000230005. 
...
\begin{itemize}
\ITEMDATE{Associate Editor di IEEE RA-L 2024-2026}
Associate Editor della rivista IEEE Robotics and Automation Letters (RA-L). 
\ITEMDATE{Associate Editor di IEEE ICRA 2023-2026}
Membro del Conference Editorial Board della IEEE International Conference on Robotics and Automation (ICRA).
\ITEMDATE{Associate Editor di IEEE IROS 2025}
Membro del Conference Editorial Board della IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS).
\ITEMDATE{Special Issue Editor di AgriEngineering 2026} 
Special Issue Editor dello special issue ``Smart Robotics and Sensors in Precision Agriculture'' della rivista AgriEngineering.
\ITEMDATE{Local Organizing Committee di Automatica 2026}
Membro del Local Organizing Committee della conferenza nazionale Automatica,  
che si terr\`a a Parma dal 2 al 4 settembre 2026. 
...
\item IEEE Transactions on AgriFood Electronics (T-AFE).
...
%
\begin{itemize}
\item dott. Antonio De Moliner tesi con titolo ``Application of Machine Learning Techniques and Data-Driven Approaches to the Modeling, Control, and Diagnosis of Thermally-Driven Systems with Integrated Electric Heating'' (ciclo XXXVII) nell'ambito del Dottorato in Ingegneria Meccatronica e dell'Innovazione del Prodotto, Universit\`a degli Studi di Padova, 2025-2026; 
\item dott. Emilio Olivastri tesi con titolo ``Robust Pose Graph Optimization for Calibration and Autonomous Robots Navigation'' (ciclo XXXVII) nell'ambito del Dottorato in Ingegneria dell’informazione, Universit\`a degli Studi di Padova, 2025;
\item dott. Omar Salem tesi con titolo ``Continous Mapping: Towards Non-Rigid SLAM'' (ciclo XXXVII) nell'ambito del Dottorato in Scienze Informatiche, Universit\`a degli Studi di Roma ``La Sapienza'', 2025; 
...
Relatore di 15 tesi di Laurea, Laurea Magistrale e Specialistica in Ingegneria Informatica presso l'Universit\`a degli Studi di Parma elencate di seguito: 
\begin{enumerate}
\item Francesco Mincione, tesi di Laurea Magistrale, ``Un sistema di localizzazione basato su Filtro di Kalman Esteso
tramite registrazione di LiDAR 3D Multi-Strato'', 
  ``A Robot Localization System based on Extended Kalman Filter using 3D Multi-layer LiDAR Registration'', 2025; 
%
\item Francesco Pasetti, tesi di Laurea Magistrale ``Riconoscimento di Landmark Artificiali per la Localizzazione di AGV Industriali
Tramite LiDAR 3D'', 
  ``Detection of Artificial Landmarks for the Localization of Industrial AGVs Using 3D LiDAR'', 2025;
%
\item Giuliano Pioldi, tesi di Laurea, ``Sviluppo di un software per il coordinamento di un robot manipolatore per la presa di frutti'', 
  ``Development of a control software for coordinating a robotic manipulator for fruit harvesting'', 2024; 
%
\item Silvester Ofori Ampomah, tesi di Laurea Magistrale, ``Realizzazione di un Sistema Robotico di Manipolazione di Frutti per Applicazioni Agricole'', 
  ``Development of a Robotic System for Fruit Manipulation in Agriculture Applications'', 2024; 
%
\item Federica Ripani, tesi di Laurea Magistrale, ``Rilevamento e stima della posa di frutti basati su tecniche di machine learning tramite telecamera di profondit\`a'', 
...
\ITEMDATE{Ottobre 2025-Presente} 
