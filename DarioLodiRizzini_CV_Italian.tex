...
\item Dario Lodi Rizzini \`e autore di \textbf{65} \emph{pubblicazioni scientifiche} complessive, di cui 
  ...
  \textbf{39} articoli su \emph{atti di conferenze internazionali} con revisione sul testo completo,
  \textbf{1} \emph{capitolo su libro internazionale}

\item Indicatori bibliometrici (al 06/11/2025): 
  \begin{itemize}
  \item Scopus: citazioni \textbf{780}, h-index \textbf{16}
  \item Google Scholar: citazioni \textbf{1139}, h-index \textbf{18}
  \end{itemize}
\end{itemize}
...
\begin{itemize}
\ITEMDATE{Associate Editor di IEEE RA-L 2024-2025}
